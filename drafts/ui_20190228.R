...
sidebar <- dashboardSidebar(
  sidebarMenu(
    ...
    menuItem('Data Preparation', tabName = 'dataPrepTabs',
             menuSubItem('Input Data', tabName = 'dataInputTab'),
             menuSubItem('Model Selection', tabName = 'modelSelectTab'),
